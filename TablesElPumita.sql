...
CREATE TABLE trabajadorCompania(
	...
	correo VARCHAR(60) NOT NULL CHECK(correo <> ''),
...
CREATE TABLE cliente(
	correo VARCHAR(60) NOT NULL CHECK(correo <> '') UNIQUE,
...
CREATE TABLE aseguradora(
	nombre VARCHAR(60) NOT NULL CHECK(nombre <> '') UNIQUE
);
...
CREATE TABLE delegacion(
	cp INT NOT NULL CHECK(cp BETWEEN 10000 AND 99999),
	alcaldia VARCHAR(40) NOT NULL CHECK(alcaldia <> '')
);
