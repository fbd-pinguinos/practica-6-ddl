...
CREATE TABLE persona(
	...
	numero INT NOT NULL,
	cp INT,
	estado VARCHAR(40) CHECK(estado <> ''),
...
CREATE TABLE tarjetaCredito(
	curp CHAR(18) NOT NULL CHECK(CHAR_LENGTH(curp) = 18),
	referenciaPago INT NOT NULL UNIQUE,
...
CREATE TABLE envioNormal(
	...
	numeroEnvio INT NOT NULL UNIQUE,
	estatus VARCHAR(30) CHECK(estatus <> ''),
	tiempoEnvio VARCHAR(15) CHECK(tiempoEnvio <> '')
);
...
CREATE TABLE envioExpress(
	...
	numeroEnvio INT NOT NULL UNIQUE,
	estatus VARCHAR(30) CHECK(estatus <> ''),
	tiempoEnvioUsuario VARCHAR(15) CHECK(tiempoEnvioUsuario <> '')
);
...
CREATE TABLE producto(
	...
	nombreProducto VARCHAR(50) CHECK(nombreProducto <> ''),
